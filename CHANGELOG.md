...
- **依賴基線更新**：以最新穩定版 Pillow 12.3.0、pytest 9.1.1、packaging 26.2、pywebview 6.2.1、PyInstaller 6.21.0、setuptools 83.0.0、wheel 0.47.0 完成本機 80 tests、PyInstaller 與 exe smoke。
